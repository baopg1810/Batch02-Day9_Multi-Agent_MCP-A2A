...
QUESTION = (
    "A tech startup with $5M revenue breached a software contract, shared user data without consent, "
...
SYSTEM_PROMPT = (
    ...
    "a comprehensive analysis. Search for each legal area separately — contract breach, "
    "data privacy, tax, and compliance. Use search_case_law for breach-of-contract questions. "
