...
def privacy_agent(state: State) -> dict:
    ...
    llm = get_llm()
    prompt = f"""Bạn là chuyên gia về GDPR và bảo vệ dữ liệu cá nhân. Phân tích khía cạnh privacy:

Câu hỏi: {state['question']}
Phân tích pháp lý: {state.get('law_analysis', 'N/A')}

Tập trung: GDPR, data protection, privacy rights, data breach, nghĩa vụ thông báo rò rỉ dữ liệu."""
